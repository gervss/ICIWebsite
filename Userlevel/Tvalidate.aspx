<%@ Page Title="" Language="C#" MasterPageFile="~/Userlevel/Teacher.master" AutoEventWireup="true" CodeFile="Tvalidate.aspx.cs" Inherits="Userlevel_Tvalidate" %>
    ...
    <br />
        ...
        <tr>
            <td style="width: 175px">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:LinkButton ID="LinkButton1" runat="server"  style="color: #000; font-size: 18pt" Font-Underline="False" PostBackUrl="~/Userlevel/Tgrades.aspx">Back</asp:LinkButton>
            </td>
