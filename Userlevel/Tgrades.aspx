<%@ Page Title="" Language="C#" MasterPageFile="~/Userlevel/Teacher.master" AutoEventWireup="true" CodeFile="Tgrades.aspx.cs" Inherits="Userlevel_Tgrades" UnobtrusiveValidationMode="none"%>
    ...
    <table>
        <tr>
            <td style="width: 175px">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:LinkButton ID="LinkButton1" runat="server"  style="color: #000; font-size: 18pt" Font-Underline="False" PostBackUrl="~/Userlevel/Tvalidate.aspx">Edit/Delete</asp:LinkButton>
            </td>
